...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-5">
    <form action="" method="GET" class="flex flex-wrap items-center gap-2 w-full md:w-auto">
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari produk..."
            class="border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-full sm:w-60">
    ...
    <a href="{{ route('admin.products.create') }}"
        class="flex items-center justify-center gap-2 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all hover:opacity-90 w-full md:w-auto"
